            ...
            Column(
              children: [
                CommonUserInfoItem.buildUserInfoItem("旧密码", TextField(
                  ...
                  decoration: InputDecoration(hintText: "输入旧密码", hintStyle: TextStyle(fontSize: 10.sp, color: Colors.grey), border: InputBorder.none,),
                )),
                ...
                CommonUserInfoItem.buildUserInfoItem("新密码", TextField(
                  ...
                  decoration: InputDecoration(hintText: "输入新密码", hintStyle: TextStyle(fontSize: 10.sp, color: Colors.grey), border: InputBorder.none,),
                )),
                ...
                CommonUserInfoItem.buildUserInfoItem("确认密码", TextField(
                  ...
                  decoration: InputDecoration(hintText: "输入确认密码", hintStyle: TextStyle(fontSize: 10.sp, color: Colors.grey), border: InputBorder.none,),
                )),
              ],
            ),
