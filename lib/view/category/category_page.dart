                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 5.w),
                                        Text("用户回收价：${recycleGood.userPrice} /kg", style: TextStyle(fontSize: 12.sp, color: const Color(0xff828081))),
                                        SystemDictUtil.isRecyclingCenterUser() ?  SizedBox(height: 5.w) : const SizedBox(),
                                        SystemDictUtil.isRecyclingCenterUser()  ?  Text("骑手回收价：${recycleGood.driverPrice} /kg", style: TextStyle(fontSize: 12.sp, color: const Color(0xff828081))) : const SizedBox(),
                                      ],
                                    ),
                        ...
                        child: Column(children: List.generate(_recycleGoodsModels.length, (index){
                          return GestureDetector(
                            child: Container(
                              ...
                              child: Text("${_recycleGoodsModels[index].name}", style: TextStyle(fontSize: 13.sp)),
                            ),
                            onTap: (){
                              currentIndex = index;
                              setState(() {});
