...
class NavBar {
  static AppBar show(String text, { List<Widget>? actions, PreferredSizeWidget? bottom}){
    return AppBar(
      ...
      leading: GestureDetector(
        child: Container(padding: EdgeInsets.all(15.w), child: Image.asset("assets/common/nav-back-black.png")),
        onTap: ()=> Get.back(),
      ),
      actions: actions,
      bottom: bottom,
  ...
  static AppBar showWidthPrimaryTheme(String text, { List<Widget>? actions, PreferredSizeWidget? bottom}){
    return AppBar(
      ...
      leading: GestureDetector(
        child: Container(padding: EdgeInsets.all(15.w), child: Image.asset("assets/common/nav-back-white.png")),
        onTap: ()=> Get.back(),
      ),
      actions: actions,
      bottom: bottom,
