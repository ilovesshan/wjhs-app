...
class ImagePreview extends StatefulWidget {
  ...
  ImagePreview(this.path, {this.isNetworkPath = false});
...
class MultipleImagePreview extends StatefulWidget {
  ...
  MultipleImagePreview(this.fileList, {this.initialPage = 0, required this.canDelete, required this.onDeletePressed});

  @override
  _MultipleImagePreviewState createState() => _MultipleImagePreviewState();
}

class _MultipleImagePreviewState extends State<MultipleImagePreview> {
